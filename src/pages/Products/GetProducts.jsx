    ...
    <div className="productsPage">
      ...
      <div className="productsData">
        ...
        <div className="productsInfo">
          ...
          {products.map((product) => (
            ...
            {/* <div className="imageWrapper"> */}
              <img
                src={product.image_url || "https://images.pexels.com/photos/90946/pexels-photo-90946.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500"}
                alt={product.name}
            ...
            {/* </div> */}
              ...
              <a className="cartBtn" href="/">In the cart</a>
            </div>
          ))}
        </div>
        ...
        <div className="pagination">
          ...
          <button className="next_previous" disabled={page <= 1} onClick={() => setPage(page - 1)}>&lt; Previous</button>
          <span> Page {page} of {totalPages} </span>
          <button className="next_previous" disabled={page >= totalPages} onClick={() => setPage(page + 1)}>Next &gt;</button>
        </div>
        </div>
      </div>
    </div>
